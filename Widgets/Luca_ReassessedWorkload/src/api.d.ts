/**
 * ============================================================================
 * PQFORCE API TYPE DECLARATIONS
 * ============================================================================
 * 
 * This file declares TypeScript type definitions for the entire PQForce API
 * The Pqf global namespace is provided by the PQForce sandbox environment
 * and is available to all widget scripts automatically
 * 
 * Key namespaces:
 * - Pqf.acm   - Access Control & Authentication
 * - Pqf.pf    - Portfolio/Common (base types and references)
 * - Pqf.pm    - Project Management (core widget API)
 * - Pqf.clf   - Common/Utility functions
 * 
 * Functions used in Reassessed Tasks widget:
 * - Pqf.pm.getProject(id)                              - Get project by ID
 * - Pqf.pm.getProjectActiveScenario(projectId, bool)  - Get active scenario
 * - Pqf.pm.getScenarioWorkItems(scenarioId, bool)     - Get work items/tasks
 * - Pqf.pm.getProjectWorkItemProgressCorrections(id)  - Get reassessments
 * - Pqf.clf.newUuids(count)                           - Generate unique IDs
 * 
 * Without this file:
 * - TypeScript wouldn't recognize Pqf.* calls
 * - Would see "unknown identifier" compile errors
 * - No IDE autocomplete for API functions
 * - Would lose type safety on API results
 * 
 * This is a minimal/partial declaration. Full API documentation is in
 * the PQForce development portal.
 */
...
namespace acm {
/**
 * @description Contains information about an API token that is requested to be authorized
 */
...
namespace acm {
/**
 * @description Contains information about an API token that is authorized
 */
...
namespace acm {
/**
 * @description Describes a challenge that has to be fulfilled by user logging in
 */
interface Challenge {
...
namespace acm {
/**
 * @description The answer to a challenge
 */
...
namespace acm {
/**
 * @description The kind of challenge to be fulfilled
 */
...
namespace acm {
/**
 * @description Describes confidentiality of an object
 */
...
namespace acm {
/**
 * @description Describes confidentiality of an object and some metadata
 */
...
namespace acm {
/**
 * @description The request for interactive login
 */
...
namespace acm {
/**
 * @description The response of the server after logout
 */
...
namespace acm {
/**
 * @description Describes a user role
 */
...
namespace acm {
/**
 * @description Describes a user role with translations
 */
...
namespace act {
/**
 * @description Describes how much time a resource spent for a project (optional with a task) on a certain day
 */
...
namespace alc {
/**
 * @description Defines how macro allocation views are grouped
 */
...
namespace alc {
/**
 * @description Contains information about a resource reservation (micro allocation)
 */
...
namespace alc {
/**
 * @description The state of an allocation in the allocation workflow
 */
...
namespace alc {
/**
 * @description Contains the history of states and transitions of a specific allocation
 */
...
namespace alc {
/**
 * @description Workload by resource (for bulk requests)
 */
...
namespace atm {
/**
 * @description Information about a compilation error of programming code
 */
...
namespace atm {
/**
 * @description Describes when to trigger a JavaScript program automatically
 */
...
namespace atm {
/**
 * @description Contains lines with JavaScript console logs
 */
...
namespace atm {
/**
 * @description A line of JavaScript console log
 */
...
namespace atm {
/**
 * @description The different types for JavaScript logs
 */
...
namespace atm {
/**
 * @description Describes a JavaScript library
 */
...
namespace atm {
/**
 * @description Contains JavaScript performance statistics
 */
...
namespace atm {
/**
 * @description Contains JavaScript performance statistics for a specific API call
 */
...
namespace atm {
/**
 * @description Contains information about the JavaScript quota
 */
...
namespace cht {
/**
 * @description A baseline definition with calendar entries
 */
...
namespace cht {
/**
 * @description Defines the metamodel of a baseline and its compatibility to different datasets
 */
...
namespace cht {
/**
 * @description Defines a baseline containing different lifecycle states
 */
...
namespace cht {
/**
 * @description Defines a baseline containing different projects
 */
...
namespace cht {
/**
 * @description Defines filters which are related to indicators
 */
...
namespace cht {
/**
 * @description Defines an indicator dimension or detail filter.
 */
...
namespace pf {
/**
 * @description Contains a simple pair of key and value
 */
...
namespace cht {
/**
 * @description Defines an aggregation of datasets (sum, average, ...)
 */
...
namespace cht {
/**
 * @description A dataset to group days according to a calendar unit
 */
...
namespace cht {
/**
 * @description A dataset that uses the lifecycle state of the baseline objects
 */
...
namespace cht {
/**
 * @description Defines the metamodel of a dataset
 */
...
namespace cht {
/**
 * @description A dataset that contains projects for given aspects
 */
...
namespace cht {
/**
 * @description A dataset that contains costs of projects for given aspects
 */
...
namespace cht {
/**
 * @description Defines a point of the scale of a value on an axis
 */
...
namespace clf {
/**
 * @description Structure that contains information about cockpit widget
 */
...
namespace clf {
/**
 * @description Structure that contains information about cockpit widget with translation
 */
...
namespace clf {
/**
 * @description A reference to an objects store
 */
...
namespace clf {
/**
 * @description Describes an error that happened on agent or other API consumer's side
 */
...
namespace clf {
/**
 * @description Array of new Universally Unique Identifiers (UUIDs)
 */
...
namespace cls {
/**
 * @description Describes an attribute which will be rated. Multiple attribute ratings result in an overall rating which will be represented by the classification
 */
...
namespace clu {
/**
 * @description Diagnostic information about cluster state
 */
...
namespace clu {
/**
 * @description State information about a node
 */
...
namespace clu {
/**
 * @description Generic state information about a cluster or a node
 */
interface State {
    state: clu.States;
    responseTime?: number;
...
namespace clu {
/**
 * @description Describes state of a node or cluster
 */
type States = unknown;
}
...
namespace dgn {
/**
 * @description Describes the server environment PQFORCE is running on
 */
...
namespace dgn {
/**
 * @description Contains information about the datastore
 */
...
namespace dgn {
/**
 * @description A simple key value pair combination
 */
interface KeyValuePair {
    key: string;
    value: string;
...
namespace dgn {
/**
 * @description Contains an error log with full failure information, suitable for developers
 */
interface ErrorLog {
    tenant: string;
    alias: string;
...
namespace dgn {
/**
 * @description Contains information about the performance of PQFORCE
 */
...
namespace dgn {
/**
 * @description Describes the performance of a process or event
 */
...
namespace dgn {
/**
 * @description Describes the historic counters of an event
 */
...
namespace dgn {
/**
 * @description Describes a range of values
 */
interface MinMax {
    min: number;
    max: number;
...
namespace dgn {
/**
 * @description Contains information about the garbage collection process
 */
...
namespace dgn {
/**
 * @description Contains information about the last garbage collection process
 */
...
namespace dpo {
/**
 * @description Special structure that contains authorization information that lets clients show or hide some interactive UI controls
 */
...
namespace dpo {
/**
 * @description Special work item or absence structure for resource disposition
 */
...
namespace dpo {
/**
 * @description Contains information about a project and its phases that is assigned to a resource
 */
...
namespace dpo {
/**
 * @description information about the projects and absences of a resource
 */
...
namespace exp {
/**
 * @description Information about a JavaScript export definition
 */
...
namespace fco {
/**
 * @description Budget positions grouped by reference (for bulk requests)
 */
...
namespace fco {
/**
 * @description A costs position of a project with its actuals
 */
...
namespace lcy {
/**
 * @description Contains an entry of history of states and transitions of a specific object
 */
...
namespace lcy {
/**
 * @description Contains the history of states and transitions of a specific object with object ID reference
 */
...
namespace lcy {
/**
 * @description Describes a state in an object's lifecycle with all sub-states
 */
...
namespace lcy {
/**
 * @description Describes a state in an object's lifecycle with all sub-states and with object ID reference
 */
...
namespace lcy {
/**
 * @description Describes a state with one specific sub-state in an object's lifecycle
 */
...
namespace lcy {
/**
 * @description Describes a state with one specific sub-state in an object's lifecycle with object ID reference
 */
...
namespace lcy {
/**
 * @description Describes a sub-state in an object's lifecycle
 */
...
namespace lcy {
/**
 * @description Describes a sub-state in an object's lifecycle with translations
 */
...
namespace lcy {
/**
 * @description Describes a transition in an object's lifecycle with translations
 */
...
namespace lcy {
/**
 * @description Describes transitions in an object's lifecycle with reference to an object ID
 */
...
namespace lcy {
/**
 * @description Lifecycle states with corresponding objects
 */
...
namespace lic {
/**
 * @description The effective usage of a license
 */
...
namespace lic {
/**
 * @description An amount of objects of a license that are in use by the tenant
 */
...
namespace main {
/**
 * @description Describes the current status of the application and connections
 */
...
namespace main {
/**
 * @description Describes the state of a single aspect of the overall application status
 */
...
namespace msg {
/**
 * @description Describes a message forwarding rule
 */
...
namespace pf {
/**
 * @description Access information to be provided in the WebSocket by the client to inform about object usage
 */
...
namespace pf {
/**
 * @description Access information to be provided in the WebSocket by the server to inform about object usage of other users
 */
...
namespace pf {
/**
 * @description TYpe of access for concurrency information over WebSocket
 */
...
namespace pf {
/**
 * @description Describes an action that was performed on any object
 */
type Action = unknown;
}
...
namespace pf {
/**
 * @description Defines how to aggregate multiple values into a single one
 */
...
namespace pf {
/**
 * @description Additional information stored in a backup file
 */
...
namespace pf {
/**
 * @description Defines a granularity (scaling) of a calendar
 */
...
namespace pf {
/**
 * @description Descriptive information about a certificate
 */
...
namespace pf {
/**
 * @description A folder to organize documents on an object
 */
...
namespace pf {
/**
 * @description Information about an error that is shown to the client in case of error (HTTP code &gt;= 400)
 */
...
namespace pf {
/**
 * @description Describes a feature view (tab) of any object
 */
interface Feature {
    type: string;
    id: string;
...
namespace pf {
/**
 * @description Information about other users viewing the same object
 */
...
namespace pf {
/**
 * @description A generic flag with true or false value
 */
interface Flag {
    enabled: boolean;
}
...
namespace pf {
/**
 * @description An item with deleted flag and last modification info
 */
...
namespace pf {
/**
 * @description The JSON table format defined by Client Team to support dynamic table visualization on client
 */
interface Jtf {
    mimeType: string;
    type: string;
...
namespace pf {
/**
 * @description The JSON table format defined by Client Team to support dynamic table and chart visualization on client
 */
...
namespace pf {
/**
 * @description Chart definition for the JSON table format defined by Client Team
 */
interface JtfChart {
    id: string;
    name: string;
...
namespace pf {
/**
 * @description Chart axis definition for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Chart axis options definition for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Chart baseline definition for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Chart format definition for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Chart dataset definition for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Chart dataset aggregation options for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Chart data type definition for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Chart type for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Metadata for the JSON table format defined by Client Team
 */
interface JtfMeta {
...
namespace pf {
/**
 * @description Metadata categories for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Metadata columns for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Column data types for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Column options for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Column aggregation options for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description Column fixed options for the JSON table format defined by Client Team
 */
...
namespace pf {
/**
 * @description A reference to a certain object, identified by type and ID with its name (to avoid further requests by client to show the reference)
 */
...
namespace pf {
/**
 * @description Structure for WebSocket notification about changed objects
 */
...
namespace pf {
/**
 * @description Describes an action that was performed on an object
 */
...
namespace pf {
/**
 * @description Version reference for property values
 */
...
namespace pf {
/**
 * @description Version references for property values
 */
...
namespace pf {
/**
 * @description Describes an explicit (configured) relation with translations
 */
...
namespace pf {
/**
 * @description Information about the current session sent to the client over WebSocket
 */
...
namespace pf {
/**
 * @description This structure defines all possible messages that may be sent from client to server over WebSocket
 */
...
namespace pf {
/**
 * @description This structure defines all possible messages that may be sent from server to client over WebSocket
 */
...
namespace pf {
/**
 * @description Contains information about the maximum concurrent requests allowed for this interaction
 */
...
namespace pf {
/**
 * @description Contains information about a recovery operation
 */
...
namespace pf {
/**
 * @description Contains information on recovered elements
 */
...
namespace pf {
/**
 * @description A shot description of the current tenant, with information that may only be available after successful authentication
 */
...
namespace pf {
/**
 * @description Describes how long an object stays in the waste bin for possible undeletion
 */
...
namespace pf {
/**
 * @description Defines a unique readable code to associate to an object type
 */
...
namespace pf {
/**
 * @description Legacy details object with version information
 */
...
namespace pf {
/**
 * @description Information about a websocket connection
 */
...
namespace pm {
/**
 * @description A single shift pattern that may be applied to work items for reservation (micro planning) of resources
 */
...
namespace pm {
/**
 * @description A shift pattern that may be applied to work items for reservation (micro planning) of resources
 */
interface ShiftPlan {
...
namespace pm {
/**
 * @description Contains a reference to an object with a factor
 */
...
namespace pm {
/**
 * @description A backup of the whole project including scenarios, risks, costs and reports
 */
...
namespace pm {
/**
 * @description Costs positions assigned to a project work item
 */
...
namespace pm {
/**
 * @description Contains information about a project portfolio
 */
...
namespace pm {
/**
 * @description A project portfolio milestone that may be referenced by the portfolio's projects
 */
...
namespace pm {
/**
 * @description Information about selected project report indicators in a project
 */
...
namespace pm {
/**
 * @description A definition of a project report indicator dimension in the user's language
 */
...
namespace pm {
/**
 * @description A definition of a project report indicator dimension with translations
 */
...
namespace pm {
/**
 * @description Contains a definition for a project report indicator in the user's language
 */
...
namespace pm {
/**
 * @description Contains a definition for a project report indicator with translations
 */
...
namespace pm {
/**
 * @description Historic value of a project report indicator selection
 */
...
namespace pm {
/**
 * @description Classification for project report indicators in the user's language
 */
...
namespace pm {
/**
 * @description A scheme how to classify project report indicators in the user's language
 */
...
namespace pm {
/**
 * @description Classification for project report indicators with translations
 */
...
namespace pm {
/**
 * @description A scheme how to classify project report indicators with translations
 */
...
namespace pm {
/**
 * @description Defines the semantic model that applies for a project report indicator
 */
...
namespace pm {
/**
 * @description Contains information whether something is editable, read-only or invisible
 */
...
namespace pm {
/**
 * @description A proposal for a new position of a milestone
 */
...
namespace pm {
/**
 * @description Describes a constraint between different milestones in the same scenario
 */
...
namespace pm {
/**
 * @description Describes a dependency between different milestones in different contexts (portfolio / scenario)
 */
...
namespace pm {
/**
 * @description Describes a reference to a dependency
 */
...
namespace pm {
/**
 * @description Describes the type of referenced milestone
 */
...
namespace pm {
/**
 * @description Describes a project management method phase in the user's language
 */
...
namespace pm {
/**
 * @description Describes a project work item (phase / milestone / folder) with additional version information
 */
...
namespace pm {
/**
 * @description Describes the progress / earned value history of a project work item
 */
...
namespace pm {
/**
 * @description Describes an element in a progress / earned value history of a project work item
 */
...
namespace pm {
/**
 * @description Describes an element in a progress / earned value history of a project work item and contains overridden items
 */
...
namespace res {
/**
 * @description Information about a resource and the link to that resource (often used to list ancestors and their relation)
 */
...
namespace res {
/**
 * @description An item with its ancestor references
 */
...
namespace res {
/**
 * @description A type of absence for resources
 */
...
namespace res {
/**
 * @description A resource (an entity that may be allocated to projects and work items)
 */
...
namespace res {
/**
 * @description A resource group (HRM, KSM, ...)
 */
...
namespace res {
/**
 * @description A resource kind, grouping different resource types with same semantics
 */
...
namespace res {
/**
 * @description A resource link type
 */
...
namespace res {
/**
 * @description A resource presence as part of its worktime model
 */
interface Presence {
    presence: boolean;
    duration: string;
...
namespace res {
/**
 * @description Presences for a specific shift
 */
interface Model {
    shift: res.ResourceShift;
...
namespace res {
/**
 * @description Availability model of a resource
 */
...
namespace res {
/**
 * @description Availabilities by resource (for bulk requests)
 */
...
namespace res {
/**
 * @description Calendar format for holiday import
 */
...
namespace res {
/**
 * @description Maps a workday scheme to weekdays or vice versa
 */
...
namespace rsk {
/**
 * @description A classification for a risk rating, occurrence probability or extent of loss, in all available languages
 */
...
namespace rsk {
/**
 * @description A time unit for risk history
 */
...
namespace rsk {
/**
 * @description Contains the definition of a risk matrix in all available languages (different classes for the dimensions)
 */
...
namespace stg {
/**
 * @description Describes the degree of achievement measured in a specific numeric metric
 */
...
namespace stg {
/**
 * @description A contribution to an objective
 */
...
namespace stg {
/**
 * @description An objective for a field of action
 */
...
namespace stg {
/**
 * @description An indicator for objective achievement measurement
 */
...
namespace stg {
/**
 * @description The type of quantitative target measurement on objective indicators
 */
...
namespace stg {
/**
 * @description Statistics about objective indicator statuses
 */
...
namespace stg {
/**
 * @description The accumulated progress of all projects by the contribution's state
 */
...
namespace tdp {
/**
 * @description Describes a relation between a PQFORCE object and any object in a third party system including some properties of both objects
 */
